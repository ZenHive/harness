...
<!-- FOCUS:BEGIN -->
**Focus phase:** 22 — Live-Run Observability — stop flying blind while an agent works (19 of 36 done · 0 in progress)
...
**Up next:** Task 356 — Chat turn-worker crash must fail fast to the caller — monitor instead of bare receive; map ensure_session already_started [D:2/B:3/U:4 → Eff:1.75] 🚀
<!-- FOCUS:END -->
