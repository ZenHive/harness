...
<!-- FOCUS:BEGIN -->
**Focus phase:** 9 — Chat Orchestrator (4 of 5 done · 0 in progress)

**Last shipped:** Task 75 — Annotate harness driver surface with descripex api() macros, Task 76 — Harness.Chat.Session GenServer with multi-turn tool-call loop, Task 77 — Harness.Chat.Anthropic backend — Req + streaming + prompt caching + tool-use, Task 79 — Headless MCP endpoint — /harness/mcp/tools + /harness/mcp/call on 2026-05-28

**Up next:** Task 78 — Harness.Dashboard.ChatLive — LiveView UI for chat orchestrator [D:4/B:8/U:6 → Eff:1.75] 🚀
<!-- FOCUS:END -->
