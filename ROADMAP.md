...
<!-- FOCUS:BEGIN -->
**Focus phase:** 22 — Live-Run Observability — stop flying blind while an agent works (13 of 35 done · 2 in progress)
...
**Up next:** Task 346 — Port the Task-163 evidence-preserving record_run merge to ResultStore.Memory [D:2/B:5/U:4 → Eff:2.25] 🎯
<!-- FOCUS:END -->
