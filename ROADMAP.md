...
<!-- FOCUS:BEGIN -->
**Focus phase:** 4 — Multi-Agent & Quota Fail-over (18 of 20 done · 1 in progress)

**Last shipped:** Task 40 — Audit-surfaced: AgentRegistry availability lost on GenServer restart, Task 41 — Codex adapter — worktree isolation breaks intermittently (cwd ignored, agent edits main checkout), Task 59 — Cross-agent grader as a repair-loop move (gated, asymmetric, budgeted), Task 67 — Audit-surfaced: Batch.run_pinned settles entire pinned queue on one adapter's pre-dispatch unavailability on 2026-05-27
