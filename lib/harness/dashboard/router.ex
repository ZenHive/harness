defmodule Harness.Dashboard.Router do
  ...
  scope "/", Harness.Dashboard do
    ...
    live("/harness/maintenance/findings/:id", MaintenanceLive, :finding)
    live("/harness/insights", InsightsLive, :index)
    live("/harness/insights/settings", InsightsLive, :settings)
    live("/harness/insights/:id", InsightsLive, :show)
