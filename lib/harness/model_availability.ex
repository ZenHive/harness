defmodule Harness.ModelAvailability do
  ...
  #
  # Ids verified 2026-09-14 against the live probes (`claude` + `codex debug models`
  # via model_availability-refresh_catalog): the seed mirrors what each CLI
  # currently accepts — a retired id here would route and fail at dispatch.
